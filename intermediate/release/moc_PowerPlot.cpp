...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PowerPlot_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 57, 2)
    ...
    "PowerPlot\0onPower\0\0std::vector<double>&\0"
    "powerMP\0powerGPU\0dt\0"
};
...
void PowerPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onPower((*reinterpret_cast< std::vector<double>(*)>(_a[1])),(*reinterpret_cast< std::vector<double>(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        default: ;
        }
    }
}
...
const QMetaObject PowerPlot::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PowerPlot.data,
      qt_meta_data_PowerPlot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PowerPlot.stringdata))
